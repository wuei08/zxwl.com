...
@ComponentScan("com.zxwl.web.datasource.dynamic")
public class DynamicDataSourceAutoConfiguration {
    ...
    public static class AnnotationDataSourceChangeConfiguration {
        ...
        @Around(value = "within(@com.zxwl.web.datasource.dynamic.UseDataSource *)||@annotation(com.zxwl.web.datasource.dynamic.UseDataSource)")
        ...
        @Around(value = "within(@com.zxwl.web.datasource.dynamic.UseDefaultDataSource *)||@annotation(com.zxwl.web.datasource.dynamic.UseDataSource)")
