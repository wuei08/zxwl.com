...
package com.zxwl.web.service.impl.datasource;
...
import com.zxwl.web.dao.datasource.DataSourceMapper;
...
import static com.zxwl.web.bean.po.datasource.DataSource.Property.*;
    ...
    protected void checkDynamicDataSourceSupport() {
        if (dynamicDataSource == null)
            logger.warn("\ndynamicDataSource is not support! if you want use it,please import " +
                    ...
                    "            <artifactId>zxwl-web-datasource</artifactId>\n" +
                    "       </dependency>" +
                    "\n<!--------------------------------------------------------->" +
                    "\n to pom.xml");
    }
