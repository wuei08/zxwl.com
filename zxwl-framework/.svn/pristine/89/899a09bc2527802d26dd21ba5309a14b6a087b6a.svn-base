...
package com.zxwl.web.service.impl.quartz;
...
import com.zxwl.web.bean.po.quartz.QuartzJob;
import com.zxwl.web.bean.po.quartz.QuartzJobHistory;
import com.zxwl.web.core.exception.BusinessException;
import com.zxwl.web.dao.quartz.QuartzJobHistoryMapper;
import com.zxwl.web.dao.quartz.QuartzJobMapper;
import com.zxwl.web.service.impl.AbstractServiceImpl;
import com.zxwl.web.service.quartz.QuartzJobHistoryService;
import com.zxwl.web.service.quartz.QuartzJobService;
...
import static com.zxwl.web.bean.po.quartz.QuartzJob.Property.enabled;
import static com.zxwl.web.bean.po.quartz.QuartzJob.Property.id;
import static com.zxwl.web.bean.po.quartz.QuartzJobHistory.Status.FAIL;
import static com.zxwl.web.bean.po.quartz.QuartzJobHistory.Status.SUCCESS;
...
public class QuartzJobServiceImpl extends AbstractServiceImpl<QuartzJob, String> implements QuartzJobService {
    ...
    JobKey createJobKey(String jobId) {
        return new JobKey(jobId, "zxwl.scheduler");
    }

    TriggerKey createTriggerKey(String jobId) {
        return new TriggerKey(jobId, "zxwl.scheduler");
    }
