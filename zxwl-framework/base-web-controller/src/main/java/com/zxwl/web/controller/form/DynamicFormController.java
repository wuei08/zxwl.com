...
package com.zxwl.web.controller.form;

import org.hsweb.ezorm.core.OptionConverter;
import org.hsweb.ezorm.rdb.meta.RDBColumnMetaData;
import org.hsweb.ezorm.rdb.meta.RDBTableMetaData;
import com.zxwl.web.bean.common.QueryParam;
import com.zxwl.web.bean.common.UpdateMapParam;
 ...
 * 将使用{@link com.zxwl.web.controller.DynamicFormAuthorizeValidator#validate(String, User, Map, String...)}进行权限验证
 *
 * @author zhouhao
 */
@RestController
...
public class DynamicFormController {
     ...
     *
     * @param name   表单名称
     * @param fileId 文件id,通过{@link com.zxwl.web.controller.file.FileController#upload(MultipartFile[])} 上传后获得
     *               使用,分割可实现同时导入多个文件
