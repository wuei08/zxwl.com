...
import com.zxwl.web.socket.cmd.support.SystemMonitorProcessor;
import com.zxwl.web.socket.message.SimpleWebSocketMessageManager;
 ...
 */
@ComponentScan(basePackages = "com.zxwl.web.socket")
@Configuration
