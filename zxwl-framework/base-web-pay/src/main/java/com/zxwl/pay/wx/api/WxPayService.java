...
import com.zxwl.pay.common.util.MatrixToImageWriter;
import com.zxwl.pay.common.util.XML;
import com.zxwl.pay.common.util.sign.SignUtils;
import com.zxwl.pay.wx.bean.WxPayError;
...
//    public final static String unifiedOrderUrl = "https://api.mch.weixin.qq.com/pay/unifiedorder";
    ...
    public JSONObject unifiedOrder(PayOrder order) {
        ...
        parameters.put("spbill_create_ip", "192.168.2.3");
        ...
        //调起支付的参数列表
        log.info("getUrl：" + getUrl(order.getTransactionType()));
