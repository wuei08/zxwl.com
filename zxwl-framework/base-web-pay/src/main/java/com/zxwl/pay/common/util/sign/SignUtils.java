package com.zxwl.pay.common.util.sign;
...
public enum SignUtils {
    ...
    MD5 {
        ...
        public String createSign(String content, String key, String characterEncoding) {
            ...
            return com.zxwl.pay.common.util.sign.encrypt.MD5.sign(content, key, characterEncoding);
        }
        ...
        public boolean verify(String text, String sign, String key, String characterEncoding) {
            return com.zxwl.pay.common.util.sign.encrypt.MD5.verify(text, sign, key, characterEncoding);
        }
    },
    ...
    RSA {
        @Override
        public String createSign(String content, String key, String characterEncoding) {
            return com.zxwl.pay.common.util.sign.encrypt.RSA.sign(content, key, characterEncoding);
        }

        @Override
        public boolean verify(String text, String sign, String publicKey, String characterEncoding) {
            return com.zxwl.pay.common.util.sign.encrypt.RSA.verify(text, sign, publicKey, characterEncoding);
        }
    },
    ...
    RSA2 {
        @Override
        public String createSign(String content, String key, String characterEncoding) {
            return com.zxwl.pay.common.util.sign.encrypt.RSA2.sign(content, key, characterEncoding);
        }

        @Override
        public boolean verify(String text, String sign, String publicKey, String characterEncoding) {
            return com.zxwl.pay.common.util.sign.encrypt.RSA2.verify(text, sign, publicKey, characterEncoding);
        }
    };
    ...
    public static String parameterText(Map parameters, String separator, String... ignoreKey ) {
        ...
        // TODO 2016/11/11 10:14 author: chendawei 已经排序好处理
        ...
        // TODO 2016/11/11 10:14 author: chendawei 未排序须处理
